...
public class FrontScreen extends JFrame {
    ...
    private static void openApproverUI() {
    	// Create an instance of ApproverUI
        Approver approverUI = new Approver();
        approverUI.setLocationRelativeTo(null); // Center the ApproverUI on the screen
    }
